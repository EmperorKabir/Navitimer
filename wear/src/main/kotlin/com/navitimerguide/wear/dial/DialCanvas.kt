package com.navitimerguide.wear.dial
...
import com.navitimerguide.wear.R
import com.navitimerguide.wear.viewmodel.ChronoState
...
private fun StaticDial(measurer: TextMeasurer, modifier: Modifier) {
    ...
    Canvas(modifier = modifier.graphicsLayer { }) {
        ...
        // drawCrownAndPushers intentionally omitted on the wear face —
        // user requested visual crown + pushers be removed from the
        // watch dial. The drawing function itself is kept below so the
        // chronograph plumbing the pushers control is preserved for a
        // future custom binding.
