...
object DialPalette {
    val DialGreenInner = Color(0xFF0E5638)
    val DialGreenOuter = Color(0xFF021A11)
    val DialGreenSpokeLight = Color(0xFF1A8455)   // sunburst spoke +lum
    val DialGreenSpokeDark = Color(0xFF073822)    // sunburst spoke -lum
    ...
    val SecondHand = Color(0xFFD7263D)
